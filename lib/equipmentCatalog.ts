...
export const INVERTERS: HybridInverter[] = [
  ...
  {
    id: 'sma-sunny-tripower-smart-energy-5',
    manufacturer: 'SMA',
    ...
    region: 'IE+UK',
    notes: 'German-engineered, the global reference inverter. Strong installer support across EU/US/AU. SMA Smart Connected free monitoring.',
    retailPrice: { currency: 'EUR', min: 1900, max: 2300, unit: 'unit only' },
  },
  {
    id: 'enphase-iq8m-microinverter',
